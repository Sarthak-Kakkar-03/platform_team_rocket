...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      peer_surveys: {
        Row: {
          ...
          target_private_profile_id: string;
        };
        Insert: {
          survey_response_id: string;
          target_private_profile_id: string;
        ...
        Relationships: [
          {
            foreignKeyName: "peer_surveys_survey_response_id_fkey";
          ...
          {
            foreignKeyName: "peer_surveys_target_private_profile_id_fkey";
            columns: ["target_private_profile_id"];
            isOneToOne: false;
            referencedRelation: "assignments_with_effective_due_dates";
            referencedColumns: ["student_profile_id"];
          },
    ...
    Functions: {
      ...
      create_survey_response_assignments: {
        Args: { p_profile_ids: string[]; p_survey_id: string };
        Returns: undefined;
      };
      create_survey_responses_for_all_students: {
      ...
      get_peer_survey_class_id: {
        Args: { p_survey_response_id: string };
        Returns: number;
      };
      get_student_summary: {
      ...
      get_survey_class_id: { Args: { p_survey_id: string }; Returns: number };
